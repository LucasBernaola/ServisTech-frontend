...
El frontend está preparado para una demo de portfolio: tiene flujos reales, autenticación, vistas protegidas, componentes responsive y comunicación completa con el backend.

Quedan como posibles mejoras futuras:

- pulir textos finales vista por vista;
- agregar tests de interfaz;
- sumar estados vacíos más específicos;
- documentar deploy final cuando quede definido el hosting.
